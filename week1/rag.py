...
Your task is to generate Python code based STRICTLY on the provided API documentation context.
Do not invent endpoints or authentication methods. Use exactly what is written in the Context.
"""
